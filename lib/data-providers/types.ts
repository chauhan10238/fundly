...
export interface FmpFundamentals { entityName: string; currency: string; revenueTTM?: number; grossProfitTTM?: number; operatingIncomeTTM?: number; netIncomeTTM?: number; operatingCashFlowTTM?: number; capitalExpenditureTTM?: number; freeCashFlowTTM?: number; cash?: number; totalDebt?: number; assets?: number; liabilities?: number; equity?: number; sharesOutstanding?: number; epsDilutedTTM?: number; bookValuePerShare?: number; grossMargin?: number; operatingMargin?: number; profitMargin?: number; freeCashFlowMargin?: number; returnOnEquity?: number; debtToEquity?: number; currentRatio?: number; sourcePeriod?: string; latestFiled?: string }
